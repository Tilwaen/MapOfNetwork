...
public class PortManagerImplTest {
    ...
    public void setUp() {
        ...
        this.testDeviceA = new Device.Builder("did", DeviceType.COMPUTER, "address", 2)
                .name("Kačer Donald")
                .build();
        this.testDeviceB = new Device.Builder("bid", DeviceType.ROUTER, "address", 4)
                .name("Hamoun")
                .build();
    }
    ...
    public void createPortForDeviceWithOccupiedPortSlots() {
        Device testDeviceC = new Device.Builder("kid", DeviceType.ROUTER, "address", 4)
                .name("Kulík")
                .build();
        Device testDeviceD = new Device.Builder("mid", DeviceType.ROUTER, "address", 4)
                .name("Dulík")
                .build();
    ...
    public void createPortForDeviceWithNoPortSlots() {
        Device testDeviceC = new Device.Builder("kid", DeviceType.ROUTER, "address", 0)
                .name("Bubík")
                .build();
        Port portAC = new Port(testDeviceA, testDeviceC);
        exception.expect(IndexOutOfBoundsException.class);
    ...
    public void createPortFromXMLForOccupiedPort() {
        Device testDeviceC = new Device.Builder("lid", DeviceType.ROUTER, "address", 4)
    ...
    public void createPortFromXMLForDeviceWithZeroPorts() {
        Device testDeviceC = new Device.Builder("pid", DeviceType.ROUTER, "address", 0)
                .name("Daisy")
                .build();
        Port portAC = new Port(testDeviceA, testDeviceC);
        exception.expect(IndexOutOfBoundsException.class);
    ...
    public void deletePort() {
        Device testDeviceC = new Device.Builder("sid", DeviceType.ROUTER, "address", 1)
